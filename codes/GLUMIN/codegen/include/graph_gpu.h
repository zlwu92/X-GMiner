...
public:
  ...
  inline __device__ __host__ vidType* get_src_ptr(eidType eid) const { return d_src_list + eid; }
  inline __device__ __host__ vidType* get_dst_ptr(eidType eid) const { return d_dst_list + eid; }
