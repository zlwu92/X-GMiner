...
BS_edge(vidType ne, 
  ...
  for(eidType eid = warp_id; eid < ne; eid += num_warps){
    ...
    __intersect(meta, __get_vlist_from_graph(g, meta, /*vid=*/v0), __get_vlist_from_graph(g, meta, /*vid=*/v1), /*upper_bound=*/v0, /*output_slot=*/0);
    ...
    for(vidType v2_idx = 0; v2_idx < candidate_v2.size(); v2_idx ++){
      ...
      count += __intersect_num(__get_vlist_from_heap(g, meta, /*slot_id=*/1), __get_vlist_from_graph(g, meta, /*vid=*/v2), /*upper_bound=*/v1);
    }
  }
  // END OF CODEGEN
