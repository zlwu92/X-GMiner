...
BS_edge(eidType ne,
  ...
  for(eidType eid = warp_id; eid < ne; eid += num_warps){
    ...
    for(vidType v2_idx = 0; v2_idx < candidate_v2.size(); v2_idx ++){
      ...
      __intersect(meta, __get_vlist_from_heap(g, meta, /*slot_id=*/1), __get_vlist_from_graph(g, meta, /*vid=*/v2), /*upper_bound=*/v1, /*output_slot=*/3);
      ...
      for(vidType v3_idx = 0; v3_idx < candidate_v3.size(); v3_idx ++){
        ...
        count += __difference_num(__get_vlist_from_heap(g, meta, /*slot_id=*/4), __get_vlist_from_graph(g, meta, /*vid=*/v3), /*upper_bound=*/-1);
      }
    }
  }
  // END OF CODEGEN
