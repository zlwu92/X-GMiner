...
BS_edge(eidType ne, 
  ...
  for(eidType eid = warp_id; eid < ne; eid += num_warps){
    ...
    for(vidType v2_idx = 0; v2_idx < candidate_v2.size(); v2_idx ++){
      ...
      __intersect(meta, __get_vlist_from_heap(g, meta, /*slot_id=*/1), __get_vlist_from_graph(g, meta, /*vid=*/v2), /*upper_bound=*/v2, /*output_slot=*/2);
      __difference(meta, __get_vlist_from_heap(g, meta, /*slot_id=*/0), __get_vlist_from_graph(g, meta, /*vid=*/v2), /*upper_bound=*/-1, /*output_slot=*/3);
      ...
      for(vidType v3_idx = 0; v3_idx < candidate_v3.size(); v3_idx ++){
        ...
        count += __intersect_num(__get_vlist_from_heap(g, meta, /*slot_id=*/3), __get_vlist_from_graph(g, meta, /*vid=*/v3), /*upper_bound=*/v3);
      }
    }
  }
  // END OF CODEGEN
