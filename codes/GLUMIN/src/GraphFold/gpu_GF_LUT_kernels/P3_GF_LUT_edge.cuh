__global__ void P3_GF_LUT_warp_edge(vidType begin, eidType end, GraphGPU g,
  ...
  for (eidType eid = warp_id; eid < end;) {
    ...
    auto cnt = difference_set(g.N(v0), v0_size, g.N(v1), v1_size, vlist);
...
__global__ void P3_GF_LUT_block_edge(vidType begin, eidType end, GraphGPU g,
  vidType *vlists, bitmapType* bitmaps, vidType max_deg, AccType *counters,
  AccType *INDEX1, Roaring_LUTManager<> LUTs) {
